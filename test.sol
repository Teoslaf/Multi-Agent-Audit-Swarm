...
contract ChristmasDinner {
    ...
    //audithe issue is that without checking deadlineSet, any function with the beforeDeadline modifier could be called before the deadline is set
    ...
    //audit locked is never sent to true
